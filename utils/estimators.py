...
def HardNegtive_loss(out_1, out_2, tau_plus=0.1, batch_size=1000, beta=1.0, temperature=0.5, estimator='hard'):
    # normalization
...
def estimate_mutual_information(estimator, data, critic_fn, baseline_fn=None, alpha_logit=None, **kwargs):
